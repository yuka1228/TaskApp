...
public class MainActivity extends AppCompatActivity {
    public final static String EXTRA_TASK = "jp.techacademy.yuka.satou.taskapp.TASK";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Log.d("test", search_edit_text.getText().toString());
                ...
                if (searchtext.length() == 0 ) {
                    ...
                    RealmResults<Task> results = mRealm.where(Task.class).equalTo("category", searchtext).findAll();
